    ...
    return (
        <div className="lg:w-[500px] w-full lg:m-4 bg-white">
            <form action="">
                ...
                <button className="w-full flex items-center justify-center text-white bg-primary border-0 py-2 px-6 focus:outline-none hover:bg-secondary text-lg"><FiSend className='text-xl text-white mr-2' />Post Review</button>
            </form>
        </div>
    );
};
