            ...
            <div className="container px-10 py-7 mx-auto">
                ...
                <div className="grid lg:grid-cols-6 md:grid-cols-3 grid-cols-1 gap-5 items-center mt-8">
                    {products &&
                        products.length > 0 &&
                        products
                            .filter((product) => product.category === "Fashion") // Filter products by category
                            .slice(-6) // Slice to get the first 6 products
                            .map((product, index) => (
