        ...
        <div className="container lg:px-12 py-16 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col text-gray-500">
            <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                ...
                <div className="flex justify-center mt-4">
                    <Link to="https://www.facebook.com/arfat.akter.98/" className="mr-6 ">
                        <img src={Facebook} alt="" className='w-6 h-6' />
                    </Link>
                    <Link to="https://www.linkedin.com/in/arfat-begum-0b22221b2/" className="mr-6 ">
                        <img src={Linkedin} alt="" className='w-7 h-7' />
                    </Link>
                    <Link to="https://twitter.com/arfatbegum" className="mr-6 ">
                        <img src={Twitter} alt="" className='w-6 h-6' />
                    </Link>
                    <Link to="https://instagram.com/arfat_akter_25" className="mr-6 ">
                        <img src={Instagram} alt="" className='w-7 h-7' />
                    </Link>
                    <Link to="https://github.com/arfatbegum" className="mr-6 ">
